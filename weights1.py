...
graph = {
    ...
    'M_1': [('AM_1', 12), ('M_2', 30)],
    'N_1': [('AN_1', 12), ('N_2', 30)],
    'AA_1': [('A_1', 10), ('AB_1', 34), ('AE_1', 21), ('AA_2', 10)],
    'AB_1': [('AA_1', 34), ('AC_1', 34), ('B_1', 10)],
    'AC_1': [('AB_1', 34), ('AD_1', 84), ('AH_1', 43), ('C_1', 24)],
    'AD_1': [('AC_1', 84), ('AF_1', 21), ('D_1', 24)],
    'AE_1': [('AA_1', 21), ('AG_1', 22), ('F_1', 14)],
    'AF_1': [('AD_1', 21), ('AI_1', 22), ('G_1', 14), ('H_1', 25)],
    'AG_1': [('AE_1', 22), ('AH_1', 68), ('AJ_1', 21), ('E_1', 32)],
    'AH_1': [('AC_1', 43), ('AG_1', 68), ('AK_1', 21), ('AI_1', 84)],
    'AI_1': [('AF_1', 22), ('AH_1', 84), ('AN_1', 47)],
    'AJ_1': [('AG_1', 21), ('AL_1', 26), ('I_1', 15)],
    'AK_1': [('AH_1', 21), ('AM_1', 26), ('J_1', 19)],
    'AL_1': [('AJ_1', 26), ('AM_1', 68), ('L_1', 12)],
    'AM_1': [('AK_1', 26), ('AL_1', 68), ('AN_1', 84), ('M_1', 12)],
    'AN_1': [('AI_1', 47), ('AM_1', 84), ('N_1', 12), ('K_1', 15)],
    # Translated dictionary nodes
    'A_2': [('AA_2', 10), ('A_1', 30)],
    'B_2': [('AB_2', 10), ('B_1', 30)],
    'C_2': [('AC_2', 24), ('C_1', 30)],
    'D_2': [('AD_2', 24), ('D_1', 30)],
    ...
    'M_2': [('AM_2', 12), ('M_1', 30)],
    'N_2': [('AN_2', 12), ('N_1', 30)],
    'AA_2': [('A_2', 10), ('AB_2', 34), ('AE_2', 21), ('AA_1', 10)],
    'AB_2': [('AA_2', 34), ('AC_2', 34), ('B_2', 10)],
    'AC_2': [('AB_2', 34), ('AD_2', 84), ('AH_2', 43), ('C_2', 24)],
    'AD_2': [('AC_2', 84), ('AF_2', 21), ('D_2', 24)],
    'AE_2': [('AA_2', 21), ('AG_2', 22), ('F_2', 14)],
    'AF_2': [('AD_2', 21), ('AI_2', 22), ('G_2', 14), ('H_2', 25)],
    'AG_2': [('AE_2', 22), ('AH_2', 68), ('AJ_2', 21), ('E_2', 32)],
    'AH_2': [('AC_2', 43), ('AG_2', 68), ('AK_2', 21), ('AI_2', 84)],
    'AI_2': [('AF_2', 22), ('AH_2', 84), ('AN_2', 47)],
    'AJ_2': [('AG_2', 21), ('AL_2', 26), ('I_2', 15)],
    'AK_2': [('AH_2', 21), ('AM_2', 26), ('J_2', 19)],
    'AL_2': [('AJ_2', 26), ('AM_2', 68), ('L_2', 12)],
    'AM_2': [('AK_2', 26), ('AL_2', 68), ('AN_2', 84), ('M_2', 12)],
    'AN_2': [('AI_2', 47), ('AM_2', 84), ('N_2', 12), ('K_2', 15)]
}
...
def calculate_vector(coord1, coord2):
    return [coord2[i] - coord1[i] for i in range(3)]
...
# Helper function to compare vectors (if they are parallel)
def are_vectors_parallel(vector1, vector2):
    ...
    return all(abs(normalized_vector1[i] - normalized_vector2[i]) < 1e-9 for i in range(3))

# Function to update the weights for parallel and equidistant edges
def update_edge_weights(graph, coordinates):
    # Create a list to store edge information (node1, node2, vector, distance, weight)
    edges = []
    for node in graph:
        for neighbor, weight in graph[node]:
            vector = calculate_vector(coordinates[node], coordinates[neighbor])
            distance = calculate_magnitude(vector)
            edges.append((node, neighbor, vector, distance, weight))
    
    # Compare each pair of edges to check for parallelism and equidistance
    for i in range(len(edges)):
        node1_a, node2_a, vector_a, distance_a, weight_a = edges[i]
        for j in range(i + 1, len(edges)):
            node1_b, node2_b, vector_b, distance_b, weight_b = edges[j]
            if are_vectors_parallel(vector_a, vector_b) and abs(distance_a - distance_b) < 1e-9:
                # If they are parallel and equidistant, assign the same weight
                new_weight = min(weight_a, weight_b)
                graph[node1_a] = [(neighbor, new_weight) if neighbor == node2_a else (neighbor, w) for neighbor, w in graph[node1_a]]
                graph[node2_a] = [(neighbor, new_weight) if neighbor == node1_a else (neighbor, w) for neighbor, w in graph[node2_a]]
                graph[node1_b] = [(neighbor, new_weight) if neighbor == node2_b else (neighbor, w) for neighbor, w in graph[node1_b]]
                graph[node2_b] = [(neighbor, new_weight) if neighbor == node1_b else (neighbor, w) for neighbor, w in graph[node2_b]]

# Update the edge weights in the graph
update_edge_weights(graph, coordinates)

# Print the updated graph (optional)
print("Updated graph with parallel and equidistant edges having the same weights:")
print(graph)
